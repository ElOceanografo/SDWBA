...
k.mag <- 100e3 * 2 * pi / sound.speed.water
k <- c(0, 0, k.mag)
...
ts <- tilt.spectrum(krill, -180, 180, freq=200e3, sound.speed=sound.speed.water,
              density=density.water, nangle=180)
ts.cont <- tilt.spectrum(krill, -180, 180, freq=200e3, sound.speed=sound.speed.water,
